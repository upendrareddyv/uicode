export const PAGES_MENU = [{
    ...
    children: [
        ...
        },
        {
            ...
            data: {
                menu: {
                    title: 'Notes', //general.menu.editors
                    icon: 'ion-edit',
                    selected: false,
                    expanded: false,
                    order: 100
        ...
        },
      {
        ...
        data: {
          menu: {
            title: 'Workbench', //general.menu.ui_features
      ...
      },
      {
        ...
        data: {
          menu: {
            title: 'Resources',//general.menu.form_elements
            icon: 'ion-compose',
            selected: false,
            expanded: false,
            order: 400,
      ...
      },
      {
        ...
        data: {
          menu: {
            title: 'User Data', //general.menu.tables
            icon: 'ion-grid',
            selected: false,
            expanded: false,
            order: 500,
      ...
      },
      {
        ...
        data: {
          menu: {
            title: 'Views', //general.menu.menu_level_1
            icon: 'ion-ios-more',
            selected: false,
            expanded: false,
            order: 700,
